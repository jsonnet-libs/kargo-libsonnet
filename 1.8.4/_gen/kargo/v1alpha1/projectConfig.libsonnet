{
  ...
  '#':: d.pkg(name='projectConfig', url='', help='"ProjectConfig is a resource type that describes the configuration of a\\nProject."'),
  ...
  '#new':: d.fn(help='new returns an instance of ProjectConfig', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'kargo.akuity.io/v1alpha1',
    kind: 'ProjectConfig',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"Spec describes the configuration of a Project."'),
  spec: {
    '#promotionPolicies':: d.obj(help='"PromotionPolicies defines policies governing the promotion of Freight to\\nspecific Stages within the Project."'),
    promotionPolicies: {
      '#stageSelector':: d.obj(help='"StageSelector is a selector that matches the Stage resource to which\\nthis policy applies."'),
      stageSelector: {
        ...
        withMatchExpressions(matchExpressions): { stageSelector+: { matchExpressions: if std.isArray(v=matchExpressions) then matchExpressions else [matchExpressions] } },
        '#withMatchExpressionsMixin':: d.fn(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchExpressions', type=d.T.array)]),
        withMatchExpressionsMixin(matchExpressions): { stageSelector+: { matchExpressions+: if std.isArray(v=matchExpressions) then matchExpressions else [matchExpressions] } },
    ...
    '#withPromotionPolicies':: d.fn(help='"PromotionPolicies defines policies governing the promotion of Freight to\\nspecific Stages within the Project."', args=[d.arg(name='promotionPolicies', type=d.T.array)]),
    withPromotionPolicies(promotionPolicies): { spec+: { promotionPolicies: if std.isArray(v=promotionPolicies) then promotionPolicies else [promotionPolicies] } },
    '#withPromotionPoliciesMixin':: d.fn(help='"PromotionPolicies defines policies governing the promotion of Freight to\\nspecific Stages within the Project."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='promotionPolicies', type=d.T.array)]),
    withPromotionPoliciesMixin(promotionPolicies): { spec+: { promotionPolicies+: if std.isArray(v=promotionPolicies) then promotionPolicies else [promotionPolicies] } },
    '#withWebhookReceivers':: d.fn(help='"WebhookReceivers describes Project-specific webhook receivers used for\\nprocessing events from various external platforms"', args=[d.arg(name='webhookReceivers', type=d.T.array)]),
    ...
    '#withWebhookReceiversMixin':: d.fn(help='"WebhookReceivers describes Project-specific webhook receivers used for\\nprocessing events from various external platforms"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='webhookReceivers', type=d.T.array)]),
